...
function Events() {
  ...
  return (
    <div className='flex flex-col items-center justify-center ml-[6vw] w-[50vw] '>
      <div className='h-[45vh] w-[75%]  m-[20px] bg-gradient-to-b from-white/10 to-white/0 backdrop-blur-[10px] border-0 rounded-[20px] shadow-[0_8px_32px_0_rgba(0,0,0,0.37)] flex items-center justify-center flex-col'>
        
        <img src={logo} alt='' className='h-[60%]'/>
        <div className='bg-white/15 backdrop-blur-[15px] rounded-2xl pt-[2px] pb-[2px] pl-[20px] pr-[20px] text-white relative w-[25%] h-[6%] text-center mt-[20px] mb-[20px]'>29th Feburary, 2050</div>
